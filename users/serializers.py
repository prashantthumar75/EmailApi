...
class ReadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ref_name = "UserReadSerializer"
        model = User
        exclude = ('password', 'is_active', 'groups',
...
class RegisterSerializer(serializers.Serializer):
    ...
    user_type = serializers.ChoiceField(
        choices=USER_TYPE_CHOICES, write_only=True)
...
class PasswordResetSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        # User Email address present in Data Base?
        if user:
            pass
        else:
            msg = _('Unable to reset password because Email Address Not Found in Data base.')
